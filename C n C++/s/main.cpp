...
int main()
{
    ...
    while(1)
    {
        printf("Press 1 to addition two complex numbers.\n");
        printf("Press 2 to subtraction two complex numbers.\n");
        printf("Press 3 to multiplication two complex numbers.\n");
        printf("Press 4 to division two complex numbers.\n");
        ...
        else if ( choice == 2 )
        {
            ...
            if ( c.img >= 0 )
                printf("subtraction of two complex numbers = %d + %di\n",c.real,c.img);
            else
                printf("subtraction of two complex numbers = %d %di\n",c.real,c.img);
        }
        else if ( choice == 3 )
        {
            ...
            if ( c.img >= 0 )
                printf("Product of two complex numbers = %d + %di\n",c.real,c.img);
            else
                printf("Product of two complex numbers = %d %di\n",c.real,c.img);
        }
        else if ( choice == 4 )
